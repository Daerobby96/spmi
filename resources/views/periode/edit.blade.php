    ...
    <div class="col-md-6">
        <div class="card card-custom">
            <div class="card-header-custom">
                <i class="bi bi-calendar-edit me-2 text-primary"></i>
                <h6 class="mb-0">Edit Periode — {{ $periode->nama }}</h6>
            </div>
            <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="keterangan" rows="3" class="form-control"
                                placeholder="Keterangan tambahan (opsional)">{{ old('keterangan', $periode->keterangan) }}</textarea>
                        </div>
